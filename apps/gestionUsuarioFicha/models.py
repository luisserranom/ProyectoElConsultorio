...
class EnfermedadesCronicas(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.id_enfermedades_cronicas,self.nombre_enfermedad)  
...
class Alergias(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.id_alergias, self.nombre_alergia)  
...
class EnfermedadesTerminales(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.id_enfermedades_terminales,self.nombre_enfermedad_terminal)  
...
class Observaciones(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.id_observacion,self.descripcion,self.fecha)  
